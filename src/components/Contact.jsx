...
const INFOS = [
  ...
  },
  {
    icon: FiLinkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/jeremie-henri',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p
          variants={itemVariants}
          style={{ color: '#7a7890', fontWeight: 300, marginBottom: '3rem', maxWidth: 480 }}
        >
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Demandez votre devis gratuit."
              required
              rows={5}
          ...
          >
                ...
                <div>
                  ...
                  {href ? (
                    <a
                      ...
                      style={{ fontSize: 13, color: '#e8e6f0', textDecoration: 'none' }}
            ...
            >
              <p style={{ fontSize: 13, color: '#7c6af7', fontWeight: 500, marginBottom: 4 }}>
                ⚡ Réponse garantie sous 24h
              </p>
              <p style={{ fontSize: 12, color: '#7a7890', lineHeight: 1.6 }}>
                Sites vitrines · Apps web · Bots Python · Dashboards · Devis gratuit et sans
                engagement.
              </p>
            </div>
          </motion.div>
